...
最新版本 / Latest: **[v0.1.0-alpha.21](https://github.com/haohow123/beanfun-launcher/releases/tag/v0.1.0-alpha.21)** (Windows)

- Installer: [`beanfun-launcher-amd64-installer.exe`](https://github.com/haohow123/beanfun-launcher/releases/download/v0.1.0-alpha.21/beanfun-launcher-amd64-installer.exe)
- Portable: [`beanfun-launcher.exe`](https://github.com/haohow123/beanfun-launcher/releases/download/v0.1.0-alpha.21/beanfun-launcher.exe)
