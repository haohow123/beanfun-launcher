...
最新版本 / Latest: **[v0.1.0-alpha.20](https://github.com/haohow123/beanfun-launcher/releases/tag/v0.1.0-alpha.20)** (Windows)

- Installer: [`beanfun-launcher-amd64-installer.exe`](https://github.com/haohow123/beanfun-launcher/releases/download/v0.1.0-alpha.20/beanfun-launcher-amd64-installer.exe)
- Portable: [`beanfun-launcher.exe`](https://github.com/haohow123/beanfun-launcher/releases/download/v0.1.0-alpha.20/beanfun-launcher.exe)
